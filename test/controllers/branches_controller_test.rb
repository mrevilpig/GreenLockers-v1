...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { apt_address: @branch.apt_address, city: @branch.city, name: @branch.name, st_address: @branch.st_address, state_id: @branch.state_id, zip: @branch.zip }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { apt_address: @branch.apt_address, city: @branch.city, name: @branch.name, st_address: @branch.st_address, state_id: @branch.state_id, zip: @branch.zip }
    assert_redirected_to branch_path(assigns(:branch))
  end
